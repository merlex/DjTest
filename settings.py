...
DATABASE_USER = 'djtest'             # Not used with sqlite3.
DATABASE_PASSWORD = 'djtest'         # Not used with sqlite3.
...
SECRET_KEY = 'm_c%w9y+jqi_@98nhs-u@dl)lpeqc-)$06249-o=s&mm@nhchx'
